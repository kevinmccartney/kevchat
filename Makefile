...
front_door_build:
	docker build -t kevchat_front_door:0.1.0 -f .\projects\local-proxy\Dockerfile .
front_door_run:
	docker run -p 80:80 kevchat_front_door:0.1.0
front_door_shell:
	docker run --rm -it --entrypoint sh kevchat_front_door:0.2.0
